CREATE TABLE Location (
  idLocation VARCHAR  NOT NULL   IDENTITY ,
  Capacity INTEGER    ,
  isOpenSpace BOOL      ,
...
CREATE TABLE Student (
  idStudent VARCHAR  NOT NULL   IDENTITY ,
...
CREATE TABLE Faculty (
  ...
  Faculty_Pod VARCHAR  NOT NULL  ,
  Name VARCHAR    ,
  Department VARCHAR    ,
  HireDate DATETIME    ,
  IsAdjunct BOOL  NOT NULL  ,
  ContactNo VARCHAR      ,
...
CREATE TABLE EventTiming (
  ...
  Location_idLocation VARCHAR  NOT NULL  ,
  StartTime DATETIME    ,
  EndTime DATETIME      ,
...
CREATE TABLE Club (
  ...
  Treasurer VARCHAR  NOT NULL  ,
  General_Secretary VARCHAR  NOT NULL  ,
...
CREATE TABLE Member (
  ...
  Student_idStudent VARCHAR  NOT NULL    ,
